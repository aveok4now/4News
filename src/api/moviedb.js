...
const personDetailsEndpoint = id => `${apiBaseUrl}/person/${id}?api_key=${movieApiKey}&language=ru-RU`
const personMoviesEndpoint = id => `${apiBaseUrl}/person/${id}/movie_credits?api_key=${movieApiKey}&language=ru-RU`
