...
export default function RateUSModal({ navigation, showRateUSModal, setShowRateUSModal, animatedValue, rating, rate }) {
    return (
        <ModalPopup
            ...
            <View
                style={[
                    { justifyContent: 'center', alignItems: 'center', flexDirection: 'row', marginTop: 5 },
                ]}>
                {[1, 2, 3, 4, 5].map(index => (
