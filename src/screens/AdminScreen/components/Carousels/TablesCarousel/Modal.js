...
export default function Modal({ showModal, onPress, onDelete, onUpdate, onSave }) {
    ...
    return (
        <ModalPopup visible={showModal} backgroundColor={'rgb(8 47 73)'}>
            ...
            <View style={{ marginVertical: 8 }}>
                <CustomButton text={'Удалить'} fgColor={fgColor} bgColor={bgColor} onPress={onDelete} />
                <CustomButton text={'Обновить'} fgColor={fgColor} bgColor={bgColor} onPress={onUpdate} />
                <CustomButton
                    type="Tertiary"
                    text={'Отмена'}
                    onPress={onPress}
